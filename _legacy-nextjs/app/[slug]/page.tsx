...
export async function generateMetadata({
  ...
  if (serviceCategory) {
    return {
      ...
      alternates: {
        canonical: `https://birthdaysurprisevadodara.com/${serviceCategory.slug}`,
      },
      openGraph: {
        title: serviceCategory.metaTitle,
        description: serviceCategory.metaDescription,
        url: `https://birthdaysurprisevadodara.com/${serviceCategory.slug}`,
        type: "website",
        locale: "en_IN",
  ...
  if (area) {
    ...
    return {
      ...
      alternates: {
        canonical: `https://birthdaysurprisevadodara.com/${area.slug}`,
      },
      openGraph: {
        title: areaTitle,
        ...
        url: `https://birthdaysurprisevadodara.com/${area.slug}`,
        type: "website",
        locale: "en_IN",
        siteName: "Friends Factory Cafe",
      },
  ...
  if (keywordData) {
    ...
    return {
      ...
      alternates: {
        canonical: `https://birthdaysurprisevadodara.com/${keywordData.keyword.slug}`,
      },
      openGraph: {
        title: keywordTitle,
        description: keywordDescription,
        url: `https://birthdaysurprisevadodara.com/${keywordData.keyword.slug}`,
        type: "website",
        locale: "en_IN",
        siteName: "Friends Factory Cafe",
      },
