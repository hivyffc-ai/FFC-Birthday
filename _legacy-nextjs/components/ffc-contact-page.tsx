                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <a 
                          ...
                          className="text-xl font-bold text-pink-500 hover:text-pink-600"
                        >
                          {siteConfig.phone}
                        </a>
                      </div>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-gray-600 space-y-2 text-sm">
                          <div>
                            <p className="font-semibold text-pink-700 mb-1">🍽️ Lunch (Indoor)</p>
                            <p>12 PM - 3 PM | 1 PM - 4 PM | 2 PM - 5 PM</p>
                          </div>
                          <div>
                            <p className="font-semibold text-pink-700 mb-1">🌅 Evening (Indoor)</p>
                            <p>4 PM - 7 PM | 5 PM - 8 PM | 6 PM - 9 PM</p>
                          </div>
                          <div>
                            <p className="font-semibold text-pink-700 mb-1">🌙 Dinner (Indoor/Rooftop)</p>
